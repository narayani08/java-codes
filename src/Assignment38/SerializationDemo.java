...
public class SerializationDemo{ 
	public static void main(String args[]){ 
		try { 
			...
			FileOutputStream objFileOp = new FileOutputStream("Object.dat"); //(1) 
			/* Code to store the state of the object */ 
			ObjectOutputStream objectOp = new ObjectOutputStream(objFileOp); //(2) 
		...
		try { 
			...
			FileInputStream objFileIp = new FileInputStream("Object.dat"); //(4) 
			ObjectInputStream objectIp = new ObjectInputStream(objFileIp); //(5) 
