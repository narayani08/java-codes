...
public class ByteWriter{ 
	...
	public static void main(String [] args){ 
		try{ 
			...
			ByteWriter objByte = new ByteWriter(); /* To Display it on the Monitor */ 
			objByte.writeBytes(System.out); 
			System.out.println("\n"); /* Write to a byte array */ 
			objByte.writeBytes(objByteArray); /* To Write the content to a file */ 
			objByte.writeBytes(objFileOp); /* Printing all elements of the byte array */ 
